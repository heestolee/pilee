...
|---|---|
| `agents` | [Codex-first subagent 모델 운용 정책](./docs/knowledge/subagent-model-policy.md) |
| `docs/knowledge` | [pilee 지식 계층과 정합성 갱신](./docs/knowledge/pilee-knowledge-system.md) |
| `extensions/archive-to-html` | [Verify Report와 증거 기반 검증 흐름](./docs/knowledge/verify-report-workflow.md) |
| `extensions/fork-panel` | [Worktree 세션 연속성과 식별성 원칙](./docs/knowledge/worktree-session-continuity.md) |
| `extensions/subagent` | [Codex-first subagent 모델 운용 정책](./docs/knowledge/subagent-model-policy.md) |
| `extensions/web-access` | [Web Search curator와 승인형 요약 흐름](./docs/knowledge/web-search-curator.md) |
| `extensions/worktree` | [Worktree 세션 연속성과 식별성 원칙](./docs/knowledge/worktree-session-continuity.md) |
| `scripts/knowledge.mjs` | [pilee 지식 계층과 정합성 갱신](./docs/knowledge/pilee-knowledge-system.md) |
| `show-report` | [Verify Report와 증거 기반 검증 흐름](./docs/knowledge/verify-report-workflow.md) |
| `skills/pilee-knowledge` | [pilee 지식 계층과 정합성 갱신](./docs/knowledge/pilee-knowledge-system.md) |
| `skills/self-healing` | [Codex-first subagent 모델 운용 정책](./docs/knowledge/subagent-model-policy.md) |
| `skills/stress-interview` | [Codex-first subagent 모델 운용 정책](./docs/knowledge/subagent-model-policy.md) |
| `skills/verify-report` | [Verify Report와 증거 기반 검증 흐름](./docs/knowledge/verify-report-workflow.md) |
| `web_search` | [Web Search curator와 승인형 요약 흐름](./docs/knowledge/web-search-curator.md) |
