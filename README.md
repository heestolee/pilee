...
| skill | `skills/pilee-final-check` | [pilee 변경은 final-check gate로 닫는다](./docs/knowledge/pilee-final-check-gate.md) |
...
43개. 도구를 등록하지 않는 익스텐션(spinner, session-title 등)은 토큰 영향 0.
...
24개. 글로벌 워크플로 스킬만 pilee에 포함. 프로젝트 고유 스킬(create-pr, self-review)은 해당 레포/private overlay에 위치.
