...
| extension | `extensions/pr-review` | [Convention Lens는 작업 종료 시 관련 판단만 투영한다](./docs/knowledge/convention-lens-event-driven-projection.md)<br>[인간 PR 리뷰는 독립 판단 뒤에 precedent를 붙인다](./docs/knowledge/human-pr-review-precedent-harness.md) |
