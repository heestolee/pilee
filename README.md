...
| extension | `extensions/frame-v2` | [Frame v2는 이해를 학습노트로 만든 뒤 작업 계약으로 승격한다](./docs/knowledge/frame-v2-learning-note-pilot.md) |
...
| extension | `extensions/study-hard` | [Frame v2는 이해를 학습노트로 만든 뒤 작업 계약으로 승격한다](./docs/knowledge/frame-v2-learning-note-pilot.md)<br>[Study Hard 엔진은 public이고 개인 publisher만 private다](./docs/knowledge/study-hard-public-engine-private-publisher.md) |
...
| skill | `skills/frame-v2` | [Frame v2는 이해를 학습노트로 만든 뒤 작업 계약으로 승격한다](./docs/knowledge/frame-v2-learning-note-pilot.md) |
...
| skill | `skills/pr-ship` | [병렬 workflow 분석은 단일 writer queue로 합류한다](./docs/knowledge/parallel-workflow-analysis-single-writer.md)<br>[Ship과 PR-Ship은 서로 다른 통합 단계다](./docs/knowledge/ship-pr-ship-review-boundary.md)<br>[Subagent는 slash command가 아니라 skill prompt를 위임받는다](./docs/knowledge/subagent-skill-delegation.md) |
...
59개. 도구를 등록하지 않는 익스텐션(spinner, session-title 등)은 토큰 영향 0.
