...
|---|---|---|
| extension | `extensions/archive-to-html` | [Verify Report와 증거 기반 검증 흐름](./docs/knowledge/verify-report-workflow.md) |
| extension | `extensions/backlog` | TODO: knowledge 문서 필요 |
| extension | `extensions/cc-system-prompt` | TODO: knowledge 문서 필요 |
| extension | `extensions/claude-code-ui` | TODO: knowledge 문서 필요 |
| extension | `extensions/claude-hooks-bridge` | TODO: knowledge 문서 필요 |
| extension | `extensions/context-loader` | TODO: knowledge 문서 필요 |
| extension | `extensions/custom-style` | TODO: knowledge 문서 필요 |
| extension | `extensions/diff-overlay` | TODO: knowledge 문서 필요 |
| extension | `extensions/dynamic-agents-md` | TODO: knowledge 문서 필요 |
| extension | `extensions/footer` | TODO: knowledge 문서 필요 |
| extension | `extensions/fork-panel` | [Worktree 세션 연속성과 식별성 원칙](./docs/knowledge/worktree-session-continuity.md) |
| extension | `extensions/idle-screensaver` | TODO: knowledge 문서 필요 |
| extension | `extensions/mcp-bridge` | TODO: knowledge 문서 필요 |
| extension | `extensions/memory-layer` | TODO: knowledge 문서 필요 |
| extension | `extensions/notify` | TODO: knowledge 문서 필요 |
| extension | `extensions/pr-comments` | TODO: knowledge 문서 필요 |
| extension | `extensions/preflight` | TODO: knowledge 문서 필요 |
| extension | `extensions/prompt-suggest-lite` | TODO: knowledge 문서 필요 |
| extension | `extensions/queued-messages` | TODO: knowledge 문서 필요 |
| extension | `extensions/retro` | TODO: knowledge 문서 필요 |
| extension | `extensions/session-title` | TODO: knowledge 문서 필요 |
| extension | `extensions/spinner` | TODO: knowledge 문서 필요 |
| extension | `extensions/subagent` | [Codex-first subagent 모델 운용 정책](./docs/knowledge/subagent-model-policy.md) |
| extension | `extensions/supervisor` | TODO: knowledge 문서 필요 |
| extension | `extensions/tasks` | TODO: knowledge 문서 필요 |
| extension | `extensions/timestamp` | TODO: knowledge 문서 필요 |
| extension | `extensions/tool-group-renderer` | TODO: knowledge 문서 필요 |
| extension | `extensions/until` | TODO: knowledge 문서 필요 |
| extension | `extensions/usage-analytics` | TODO: knowledge 문서 필요 |
| extension | `extensions/usage-reporter` | TODO: knowledge 문서 필요 |
| extension | `extensions/utils` | TODO: knowledge 문서 필요 |
| extension | `extensions/web-access` | [Web Search curator와 승인형 요약 흐름](./docs/knowledge/web-search-curator.md) |
| extension | `extensions/working-text` | TODO: knowledge 문서 필요 |
| extension | `extensions/worktree` | [Worktree 세션 연속성과 식별성 원칙](./docs/knowledge/worktree-session-continuity.md) |
| skill | `skills/ask-user-question-rules` | TODO: knowledge 문서 필요 |
| skill | `skills/code-review-and-quality` | TODO: knowledge 문서 필요 |
| skill | `skills/db-write` | TODO: knowledge 문서 필요 |
| skill | `skills/db-write-migration` | TODO: knowledge 문서 필요 |
| skill | `skills/debugging-and-error-recovery` | TODO: knowledge 문서 필요 |
| skill | `skills/decide` | TODO: knowledge 문서 필요 |
| skill | `skills/frame` | TODO: knowledge 문서 필요 |
| skill | `skills/git-workflow-and-versioning` | TODO: knowledge 문서 필요 |
| skill | `skills/incremental-implementation` | TODO: knowledge 문서 필요 |
| skill | `skills/jira-issue-management` | TODO: knowledge 문서 필요 |
| skill | `skills/pilee-knowledge` | [pilee 지식 계층과 정합성 갱신](./docs/knowledge/pilee-knowledge-system.md) |
| skill | `skills/self-healing` | [Codex-first subagent 모델 운용 정책](./docs/knowledge/subagent-model-policy.md) |
| skill | `skills/skill-creator` | TODO: knowledge 문서 필요 |
| skill | `skills/start-local-dev` | TODO: knowledge 문서 필요 |
| skill | `skills/stress-interview` | [Codex-first subagent 모델 운용 정책](./docs/knowledge/subagent-model-policy.md) |
| skill | `skills/systematic-debugging` | TODO: knowledge 문서 필요 |
| skill | `skills/tft-guidelines` | TODO: knowledge 문서 필요 |
| skill | `skills/verify` | TODO: knowledge 문서 필요 |
| skill | `skills/verify-report` | [Verify Report와 증거 기반 검증 흐름](./docs/knowledge/verify-report-workflow.md) |
| agent | `agents` | [Codex-first subagent 모델 운용 정책](./docs/knowledge/subagent-model-policy.md) |
| script | `scripts/knowledge.mjs` | [pilee 지식 계층과 정합성 갱신](./docs/knowledge/pilee-knowledge-system.md) |
| docs | `docs/knowledge` | [pilee 지식 계층과 정합성 갱신](./docs/knowledge/pilee-knowledge-system.md) |
| concern | `show-report` | [Verify Report와 증거 기반 검증 흐름](./docs/knowledge/verify-report-workflow.md) |
| concern | `web_search` | [Web Search curator와 승인형 요약 흐름](./docs/knowledge/web-search-curator.md) |
...
| **fork-panel** | Ghostty 패널 분할 포크 + `P1/P2` 식별자 + parent inbox(`/panels`) + `/handoff`/`/done` + `/revive`/`/repanel` |
