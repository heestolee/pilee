...
| extension | `extensions/work-context` | [Task overlay는 작업 맵을 보존한다](./docs/knowledge/task-work-map-overlay.md)<br>[Working Context Card는 큰 맥락을 현재 slice로 압축한다](./docs/knowledge/work-context-card-task-board.md) |
...
| **tasks** | 영역별 work-map overlay + 태스크 CRUD + `Ctrl+Shift+T` |
