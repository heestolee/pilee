...
실행한 마이그레이션을 아래에 추가. 포맷: `- YYYY-MM-DD <설명>, [세션-id]`

- 2026-04-20 파트너쉽 정산 상태(정산 예정/완료) 백필 마이그레이션 (3,895 batch + 80,977 items)
- 2026-04-22 카테고리 v2 → v1 롤백 (1,830 category_translation 재생성, 8.357s 완료)
