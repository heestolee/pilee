...
| V | 근거 출처 | PM-readable 성공 기준 | primary action | actor/role | subject identity | 화면 oracle | primary capture | 상태 |
|---|-----------|----------------------|----------------|------------|------------------|-------------|-----------------|------|
| V1 | Jira/Notion/Slack/PR/user | 비개발자가 이해할 한 문장 | create/update/read-display/permission/event | admin/member/partner/anonymous | 같은 row/order/review/item/user를 보장하는 id | 화면에 보여야 하는 텍스트/상태/흐름 | focused crop/GIF/viewport | ready/unknown/blocked |
...
| V | 근거 출처 | PM-readable 성공 기준 | primary action | actor/role | subject identity | 화면 oracle | primary capture | 상태 |
|---|-----------|----------------------|----------------|------------|------------------|-------------|-----------------|------|
| V1 | ... | ... | create/update/read-display | ... | ... | ... | focused crop/GIF | ready |
