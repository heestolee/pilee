...
사용자가 볼 지점은 README 전체 diff가 아니라 public narrative 변경입니다. generated knowledge table, review queue, coverage graph 같은 자동 산출물은 사용자의 철학 검토 대상에서 제외하고, 사람이 쓴 소개·포지셔닝·가치 판단 문장만 검토 큐에 올립니다.
