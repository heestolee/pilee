...
| [반복 워크플로 실패는 guard/flow로 고정한다](./workflow-guard-enforced-flow.md) | active | high | 2026-05-24 | 062f9f2 | workflow, guard, intent, audit, hotfix, continuation |
| [작업 절차의 무게는 변경 리스크에 비례해야 한다](./workflow-weight-proportionality.md) | active | high | 2026-05-24 | 062f9f2 | workflow, frame, tft, hotfix, scope, incremental |
