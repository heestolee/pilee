...
| [TFT Studio는 TFT 단계를 작업 단위 UI로 묶는다](./frame-studio-interactive-decision-ui.md) | active | high | 2026-09-02 | 8a34b6a | tft-studio, frame-studio, frame, glimpse, ask-user-question, decision-ui |
