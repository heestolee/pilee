...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [Deterministic fallback은 workflow를 보존한다](./deterministic-fallbacks-preserve-workflow.md) | active | high | 2026-05-07 | 5c15964 | fallback, deterministic, model-failure, resilience, web-search, report |
| [MCP stderr는 TUI 출력이 아니다](./mcp-stderr-isolation.md) | active | high | 2026-05-07 | 67f2836 | mcp, stderr, stdio, terminal, tui, noise |
| [터미널 연동은 host adapter로 다룬다](./terminal-host-integration.md) | active | high | 2026-05-07 | 5c15964 | terminal, ghostty, applescript, notify, host, integration |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [완료 선언은 증거 뒤에만 온다](./evidence-first-verification-gate.md) | active | high | 2026-05-07 | 5c15964 | verify, evidence, gate, done, ready, verification |
...
| [Verify Report와 coverage-aware 증거 검증 흐름](./verify-report-workflow.md) | active | high | 2026-05-07 | 5c15964 | verify-report, verification, evidence, coverage, capture, crop |
...
| [Web Search curator와 승인형 요약 흐름](./web-search-curator.md) | active | high | 2026-05-07 | 5c15964 | web-search, tavily, curator, glimpse, summary-review, korean-output |
...
| [Live artifact는 local preview first다](./live-artifact-preview-pattern.md) | active | high | 2026-05-07 | 5c15964 | artifact, glimpse, preview, sse, upload, local-first |
...
| [Worktree는 실행 경계다](./worktree-execution-boundary.md) | active | high | 2026-05-07 | 5c15964 | worktree, workspace, repo, branch, execution-boundary, 워크트리 |
