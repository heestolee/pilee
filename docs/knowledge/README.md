...
| [TFT Studio는 TFT 단계를 작업 단위 UI로 묶는다](./frame-studio-interactive-decision-ui.md) | active | high | 2026-05-19 | 1f5c3ac | tft-studio, frame-studio, frame, glimpse, ask-user-question, decision-ui |
