...
| [To-production은 source-preserving hotfix 이식이다](./to-production-source-preserving-hotfix.md) | active | high | 2026-05-20 | c966e58 | to-production, hotfix, production, git, worktree, source-preserving |
