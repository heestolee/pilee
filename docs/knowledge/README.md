...
| [Retro는 private reflection이다](./retro-private-reflection-boundary.md) | active | high | 2026-05-07 | 8b79c81 | retro, notion, reflection, private, journal, 회고 |
...
| [터미널 연동은 host adapter로 다룬다](./terminal-host-integration.md) | active | high | 2026-05-07 | d601ac0 | terminal, ghostty, applescript, notify, host, integration |
...
| [Verify Report와 coverage-aware 증거 검증 흐름](./verify-report-workflow.md) | active | high | 2026-05-07 | d601ac0 | verify-report, verification, evidence, coverage, capture, crop |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [검토 산출물은 다시 열 수 있어야 한다](./artifact-archive-reopenability.md) | active | high | 2026-05-07 | d601ac0 | artifact, archive, show-report, history, html, reopen |
...
| [Private overlay package는 회사·개인 실행 맥락을 담는다](./private-overlay-package-boundary.md) | active | high | 2026-05-08 | 4cea4f7 | privacy, package, overlay, skill, company-context |
...
| [Skill은 재사용 가능한 절차다](./skills-as-portable-procedures.md) | active | high | 2026-05-07 | d601ac0 | skill, skill-creator, procedure, porting, workflow, 스킬 |
...
| [Worktree 생성은 부모 패널의 게이트다](./worktree-creation-parent-gate.md) | active | high | 2026-05-08 | 9f8a355 | worktree, fork-panel, parent-panel, hotfix, context, profile-driven |
| [Worktree 의존성 준비는 조건부 worker가 맡는다](./worktree-dependency-bootstrap-worker.md) | active | high | 2026-05-08 | 9f8a355 | worktree, dependencies, bootstrap, profile-driven, worker |
| [Worktree는 실행 경계다](./worktree-execution-boundary.md) | active | high | 2026-05-07 | d601ac0 | worktree, workspace, repo, branch, execution-boundary, 워크트리 |
