...
| [터미널 workspace 복원은 snapshot과 host adapter를 분리한다](./terminal-workspace-restore.md) | active | high | 2026-05-15 | 3a8951b | workspace, terminal, ghostty, snapshot, restore, session |
