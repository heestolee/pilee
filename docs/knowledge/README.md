...
| [Verify Report 전에는 PM-facing 계약과 readiness를 먼저 잠근다](./verify-report-preflight-readiness.md) | active | high | 2026-05-30 | 3b49f49 | verify-report, preflight, readiness, capture, data, account |
| [Verify Report와 coverage-aware 증거 검증 흐름](./verify-report-workflow.md) | active | high | 2026-05-30 | 3b49f49 | verify-report, verification, evidence, coverage, capture, crop |
