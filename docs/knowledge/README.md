...
| [Self-healing은 actionable item만 수정한다](./self-healing-actionable-loop.md) | active | high | 2026-05-10 | 8a66b77 | self-healing, actionable, worker, fix-class, subagent, 자동수정 |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [Architecture friction은 TFT의 검증 축이다](./architecture-friction-tft-lens.md) | active | high | 2026-05-10 | 8a66b77 | architecture, frame, decide, verify, deep-module, shallow-module |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [수정 전에 근본 원인을 좁힌다](./root-cause-before-fix.md) | active | high | 2026-05-10 | 8a66b77 | debugging, root-cause, triage, error-recovery, systematic, 디버깅 |
...
| [MCP stderr는 TUI 출력이 아니다](./mcp-stderr-isolation.md) | active | high | 2026-05-10 | 8a66b77 | mcp, stderr, stdio, terminal, tui, noise |
| [터미널 연동은 host adapter로 다룬다](./terminal-host-integration.md) | active | high | 2026-05-10 | 8a66b77 | terminal, ghostty, applescript, notify, host, integration |
...
| [색상은 정보 위계다](./theme-information-hierarchy.md) | active | high | 2026-05-10 | 8a66b77 | theme, color, dim, muted, border, accent |
...
| [TUI 렌더링 경계에서는 문자열을 신뢰하지 않는다](./tui-rendering-sanitization.md) | active | high | 2026-05-10 | 8a66b77 | tui, rendering, newline, ansi, sanitize, terminal |
...
| [Frame과 Verify는 구조화 계약이다](./frame-verify-contract.md) | active | high | 2026-05-10 | 8a66b77 | frame, verify, frame-json, success-criteria, contract, verification |
...
| [Decide는 선택을 한 번 공격한다](./decide-tradeoff-challenge.md) | active | high | 2026-05-10 | 8a66b77 | decide, tradeoff, challenge, productive-resistance, frame-json, decision |
...
| [Fork-panel handoff는 parent inbox로 들어간다](./fork-panel-parent-inbox.md) | active | high | 2026-05-10 | 8a66b77 | fork-panel, handoff, inbox, inject, parent, panel |
| [Fork-panel 위치는 작업 맥락의 일부다](./fork-panel-spatial-continuity.md) | active | high | 2026-05-10 | 8a66b77 | fork-panel, revive, repanel, ghostty, spatial, panel |
...
| [Private overlay package는 회사·개인 실행 맥락을 담는다](./private-overlay-package-boundary.md) | active | high | 2026-05-10 | 8a66b77 | privacy, package, overlay, skill, company-context |
| [Queued command는 실행 보장이 아니다](./queued-command-prefill-boundary.md) | active | high | 2026-05-10 | 8a66b77 | queued-messages, slash-command, prefill, worktree, session, boundary |
...
| [종료된 포크는 transcript 주입보다 revive가 우선이다](./revive-over-transcript-recall.md) | active | high | 2026-05-10 | 8a66b77 | revive, recall, fork-panel, session, continuity, 세션 |
...
| [세션 식별자는 파일명이 아니라 사람이 본 이름이다](./session-identity-over-filenames.md) | active | high | 2026-05-10 | 8a66b77 | session, title, identity, session_info, worktree, revive |
...
| [Worktree 생성은 부모 패널의 게이트다](./worktree-creation-parent-gate.md) | active | high | 2026-05-10 | 8a66b77 | worktree, fork-panel, parent-panel, hotfix, context, profile-driven |
| [Worktree 의존성 준비는 조건부 worker가 맡는다](./worktree-dependency-bootstrap-worker.md) | active | high | 2026-05-10 | 8a66b77 | worktree, dependencies, bootstrap, profile-driven, worker, subagent |
| [Worktree는 실행 경계다](./worktree-execution-boundary.md) | active | high | 2026-05-10 | 8a66b77 | worktree, workspace, repo, branch, execution-boundary, 워크트리 |
| [Worktree 세션 연속성과 식별성 원칙](./worktree-session-continuity.md) | active | high | 2026-05-10 | 8a66b77 | worktree, session, revive, fork-panel, panel-inbox, handoff |
