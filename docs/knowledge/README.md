...
| [Study Hard worker는 유연하게 생성하고 extension coordinator가 엄격하게 적용한다](./study-hard-worker-flexible-generation-strict-apply.md) | active | high | 2026-07-25 | 33d8ac2 | study-hard, subagent, worker, three-way-merge, optimistic-concurrency, glimpse |
