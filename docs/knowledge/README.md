...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [Idle UI는 장식이 아니라 ambient status다](./ambient-status-surfaces.md) | active | high | 2026-05-21 | 9b55f18 | idle-screensaver, tasks, spinner, status, ambient, ui |
...
| [User-facing 출력은 한국어를 기본으로 한다](./korean-first-user-facing-output.md) | active | high | 2026-05-26 | 1f5c3ac | korean-output, localization, web-search, ui, rewrite, 한국어 |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [검토 산출물은 다시 열 수 있어야 한다](./artifact-archive-reopenability.md) | active | high | 2026-05-25 | 77307ef | artifact, archive, show-report, archive-command, history, html |
...
| [TFT Studio는 TFT 단계를 작업 단위 UI로 묶는다](./frame-studio-interactive-decision-ui.md) | active | high | 2026-05-20 | 44ae158 | tft-studio, frame-studio, frame, glimpse, ask-user-question, decision-ui |
