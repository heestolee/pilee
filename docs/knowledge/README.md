...
|---|---|---:|---:|---:|---|
| [Self-healing은 actionable item만 수정한다](./self-healing-actionable-loop.md) | active | high | 2026-05-08 | 667cefb | self-healing, actionable, worker, fix-class, subagent, 자동수정 |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [수정 전에 근본 원인을 좁힌다](./root-cause-before-fix.md) | active | high | 2026-05-08 | 667cefb | debugging, root-cause, triage, error-recovery, systematic, 디버깅 |
...
| [터미널 연동은 host adapter로 다룬다](./terminal-host-integration.md) | active | high | 2026-05-08 | 667cefb | terminal, ghostty, applescript, notify, host, integration |
...
| [색상은 정보 위계다](./theme-information-hierarchy.md) | active | high | 2026-05-08 | 667cefb | theme, color, dim, muted, border, accent |
...
| [Frame과 Verify는 구조화 계약이다](./frame-verify-contract.md) | active | high | 2026-05-08 | 667cefb | frame, verify, frame-json, success-criteria, contract, verification |
...
| [Verify Report와 coverage-aware 증거 검증 흐름](./verify-report-workflow.md) | active | high | 2026-05-08 | a09b322 | verify-report, verification, evidence, coverage, capture, crop |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [검토 산출물은 다시 열 수 있어야 한다](./artifact-archive-reopenability.md) | active | high | 2026-05-08 | a9aee68 | artifact, archive, show-report, history, html, reopen |
...
| [Frame Studio는 frame 질문을 작업 단위 UI로 묶는다](./frame-studio-interactive-decision-ui.md) | active | high | 2026-05-08 | a09b322 | frame-studio, frame, glimpse, ask-user-question, decision-ui, co-thinking |
...
| [Private overlay package는 회사·개인 실행 맥락을 담는다](./private-overlay-package-boundary.md) | active | high | 2026-05-08 | 667cefb | privacy, package, overlay, skill, company-context |
...
| [Worktree는 실행 경계다](./worktree-execution-boundary.md) | active | high | 2026-05-08 | 667cefb | worktree, workspace, repo, branch, execution-boundary, 워크트리 |
