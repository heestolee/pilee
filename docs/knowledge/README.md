...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [Idle UI는 장식이 아니라 ambient status다](./ambient-status-surfaces.md) | active | high | 2026-05-20 | a27e674 | idle-screensaver, tasks, spinner, status, ambient, ui |
...
| [To-production은 source-preserving hotfix 이식이다](./to-production-source-preserving-hotfix.md) | active | high | 2026-05-20 | 2f47d81 | to-production, hotfix, production, git, worktree, source-preserving |
