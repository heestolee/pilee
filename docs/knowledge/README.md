...
| [정확한 기획 근거가 있으면 Frame은 추적 매트릭스를 만든다](./source-grounded-frame-planning.md) | active | high | 2026-05-30 | c32c8f8 | frame, tft-studio, planning, requirements, traceability, work-map |
...
| [TFT visual은 구조 변화를 학습 가능한 그림으로 보여준다](./tft-visual-structure-renderer.md) | active | high | 2026-05-30 | c32c8f8 | tft-studio, tft-visual, elkjs, schema-diff, database, diagram |
