...
| [Hybrid subagent 모델 운용 정책](./subagent-model-policy.md) | active | high | 2026-08-31 | 2131273 | subagent, codex, claude, model-policy, worker, finder |
...
| [학습노트 companion은 독립 canonical을 sidecar로 연결한다](./learning-note-companion-artifact.md) | active | high | 2026-08-31 | 9cbc99c | learning-note, companion-artifact, frame-v2, study-hard, worktree, checkpoint |
| [질문 UI와 실행 owner는 분리한다](./question-ui-execution-owner-routing.md) | active | high | 2026-08-30 | a198cf2 | question-runtime, orchestration, direct, worker, study-hard, meta-review |
...
| [Knowledge review queue는 PR body에 남긴다](./knowledge-review-queue-pr-body.md) | active | high | 2026-06-02 | e19936a | knowledge, review-queue, github-actions, pr-body, ember-ship |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [Diff는 실제 integration target을 기준으로 계산한다](./diff-base-follows-integration-target.md) | active | high | 2026-08-03 | 4b69e4e | diff-overlay, pull-request, stacked-pr, merge-base, review |
...
| [TUI 렌더링 경계에서는 문자열을 신뢰하지 않는다](./tui-rendering-sanitization.md) | active | high | 2026-08-26 | 3550c0d | tui, rendering, newline, ansi, sanitize, terminal |
...
| [Verify Report와 coverage-aware 증거 검증 흐름](./verify-report-workflow.md) | active | high | 2026-06-18 | 694e155 | verify-report, verification, evidence, coverage, capture, crop |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [웹 검색은 승인된 출처 선택을 거친다](./curator-approved-source-selection.md) | active | high | 2026-06-02 | 63f2a62 | web-search, curator, source-selection, approval, tavily, 검색 |
| [Web Search curator와 승인형 요약 흐름](./web-search-curator.md) | active | high | 2026-06-02 | 61ccbc9 | web-search, tavily, curator, glimpse, summary-review, korean-output |
...
| [Auto-commit은 명시 계획만 실행한다](./auto-commit-explicit-plan-gate.md) | active | high | 2026-08-26 | dd55c10 | auto-commit, git, commit, plan, safety |
...
| [Frame은 마지막에 Plan을 합성한다](./frame-plan-synthesis-continuity.md) | active | high | 2026-08-26 | 272c85b | frame, implementation-plan, tft-studio, worktree, continuity, planning |
...
| [Meta Review는 전체 diff 설명 뒤에 독립 판단과 precedent를 붙인다](./human-pr-review-precedent-harness.md) | active | high | 2026-08-30 | 3c7b116 | pr-review, human-review, precedent, evidence, glimpse, meta-review |
...
| [병렬 workflow 분석은 단일 writer queue로 합류한다](./parallel-workflow-analysis-single-writer.md) | active | high | 2026-06-17 | 7e9ee6f | ci-ship, pr-ship, self-healing, subagent, steering, writer-queue |
...
| [Queued command는 실행 보장이 아니다](./queued-command-prefill-boundary.md) | active | high | 2026-08-26 | 272c85b | queued-messages, slash-command, prefill, worktree, session, boundary |
...
| [Ship과 PR-Ship은 서로 다른 통합 단계다](./ship-pr-ship-review-boundary.md) | active | high | 2026-08-22 | e9f0549 | ship, pr-ship, pr-review, github, commit, push |
...
| [작업공간 동작과 panel activation은 별도 계약이다](./workspace-action-panel-activation-contract.md) | active | high | 2026-08-31 | 0b551c0 | workspace, worktree, branch, activation, panel, authorization |
| [Worktree 생성은 현재 패널 대화가 source다](./worktree-creation-parent-gate.md) | active | high | 2026-08-26 | 272c85b | worktree, fork-panel, current-panel, hotfix, context, profile-driven |
| [Worktree 의존성 준비는 조건부 worker가 맡는다](./worktree-dependency-bootstrap-worker.md) | active | high | 2026-08-26 | 272c85b | worktree, dependencies, bootstrap, profile-driven, worker, subagent |
| [Worktree는 실행 경계다](./worktree-execution-boundary.md) | active | high | 2026-08-31 | 0b551c0 | worktree, workspace, repo, branch, execution-boundary, cwd-binding |
| [Worktree 세션 연속성과 식별성 원칙](./worktree-session-continuity.md) | active | high | 2026-08-31 | 0b551c0 | worktree, session, revive, fork-panel, panel-inbox, handoff |
...
graph TD
  ...
  doc_human_pr_review_precedent_harness["Meta Review는 전체 diff 설명 뒤에 독립 판단과 precedent를 붙인다"]
  ...
  doc_parallel_workflow_analysis_single_writer["병렬 workflow 분석은 단일 writer queue로 합류한다"]
  ...
  doc_test_boundary_refactor["테스트는 책임 경계에 맞춰 다듬는다"]
  ...
  doc_workspace_action_panel_activation_contract["작업공간 동작과 panel activation은 별도 계약이다"]
  ...
  doc_subagent_prompt_specificity --> doc_mcp_digest_first_artifacts
  doc_subagent_prompt_specificity --> doc_parallel_workflow_analysis_single_writer
  ...
  doc_frame_plan_synthesis_continuity --> doc_workspace_action_panel_activation_contract
  ...
  doc_parallel_workflow_analysis_single_writer --> doc_ci_ship_failure_response_boundary
  doc_parallel_workflow_analysis_single_writer --> doc_queued_command_prefill_boundary
  doc_parallel_workflow_analysis_single_writer --> doc_self_healing_actionable_loop
  doc_parallel_workflow_analysis_single_writer --> doc_ship_pr_ship_review_boundary
  doc_parallel_workflow_analysis_single_writer --> doc_subagent_skill_delegation
  ...
  doc_queued_command_prefill_boundary --> doc_workspace_action_panel_activation_contract
  ...
  doc_workspace_action_panel_activation_contract --> doc_frame_plan_synthesis_continuity
  doc_workspace_action_panel_activation_contract --> doc_human_pr_review_precedent_harness
  doc_workspace_action_panel_activation_contract --> doc_queued_command_prefill_boundary
  doc_workspace_action_panel_activation_contract --> doc_worktree_creation_parent_gate
  doc_workspace_action_panel_activation_contract --> doc_worktree_dependency_bootstrap_worker
  doc_workspace_action_panel_activation_contract --> doc_worktree_execution_boundary
  doc_workspace_action_panel_activation_contract --> doc_worktree_session_continuity
  doc_worktree_creation_parent_gate --> doc_workspace_action_panel_activation_contract
  ...
  doc_worktree_dependency_bootstrap_worker --> doc_workspace_action_panel_activation_contract
  ...
  doc_worktree_execution_boundary --> doc_workspace_action_panel_activation_contract
  ...
  doc_worktree_session_continuity --> doc_workspace_action_panel_activation_contract
```
