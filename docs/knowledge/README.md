...
| [작업공간 동작과 panel activation은 별도 계약이다](./workspace-action-panel-activation-contract.md) | active | high | 2026-08-31 | 10f943e | workspace, worktree, branch, activation, panel, authorization |
...
| [Worktree 세션 연속성과 식별성 원칙](./worktree-session-continuity.md) | active | high | 2026-08-31 | 10f943e | worktree, session, revive, fork-panel, panel-inbox, handoff |
