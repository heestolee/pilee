...
| [Worktree 의존성 준비는 조건부 worker가 맡는다](./worktree-dependency-bootstrap-worker.md) | active | high | 2026-05-19 | 7d0cf97 | worktree, dependencies, bootstrap, profile-driven, worker, subagent |
