...
| [작업공간 동작과 panel activation은 별도 계약이다](./workspace-action-panel-activation-contract.md) | active | high | 2026-09-03 | 0e54c4d | workspace, worktree, branch, activation, panel, authorization |
