...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [수정 전에 근본 원인을 좁힌다](./root-cause-before-fix.md) | active | high | 2026-05-13 | e0dc999 | debugging, root-cause, triage, error-recovery, systematic, 디버깅 |
...
| [터미널 workspace 복원은 snapshot과 host adapter를 분리한다](./terminal-workspace-restore.md) | active | high | 2026-05-15 | 7496d7e | workspace, terminal, ghostty, snapshot, restore, session |
...
| [Frame과 Verify는 구조화 계약이다](./frame-verify-contract.md) | active | high | 2026-05-13 | e0dc999 | frame, verify, frame-json, success-criteria, contract, verification |
...
| [Queued command는 실행 보장이 아니다](./queued-command-prefill-boundary.md) | active | high | 2026-05-19 | 8dd65c1 | queued-messages, slash-command, prefill, worktree, session, boundary |
...
| [Worktree 생성은 현재 패널 대화가 source다](./worktree-creation-parent-gate.md) | active | high | 2026-05-19 | 8dd65c1 | worktree, fork-panel, current-panel, hotfix, context, profile-driven |
...
| [Worktree 세션 연속성과 식별성 원칙](./worktree-session-continuity.md) | active | high | 2026-05-19 | 8dd65c1 | worktree, session, revive, fork-panel, panel-inbox, handoff |
