...
| [질문 UI와 실행 owner는 분리한다](./question-ui-execution-owner-routing.md) | active | high | 2026-09-03 | 4266cfd | question-runtime, orchestration, direct, worker, study-hard, meta-review |
| [Study Hard 엔진은 public이고 개인 publisher만 private다](./study-hard-public-engine-private-publisher.md) | active | high | 2026-09-03 | cbbb829 | study-hard, public-private-boundary, notion, runtime-profile, local-state |
...
| [TUI 렌더링 경계에서는 문자열을 신뢰하지 않는다](./tui-rendering-sanitization.md) | active | high | 2026-09-01 | 8c1ef4c | tui, rendering, newline, ansi, sanitize, terminal |
...
| [Meta Review는 전체 diff 설명 뒤에 독립 판단과 precedent를 붙인다](./human-pr-review-precedent-harness.md) | active | high | 2026-09-03 | 4266cfd | pr-review, human-review, precedent, evidence, glimpse, meta-review |
