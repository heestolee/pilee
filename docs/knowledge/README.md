...
| [TFT visual은 구조 변화를 학습 가능한 그림으로 보여준다](./tft-visual-structure-renderer.md) | active | high | 2026-06-04 | d8f8c4c | tft-studio, tft-visual, elkjs, schema-diff, database, diagram |
