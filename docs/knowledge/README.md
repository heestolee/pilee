...
| [작업공간 동작과 panel activation은 별도 계약이다](./workspace-action-panel-activation-contract.md) | active | high | 2026-08-31 | 090cb14 | workspace, worktree, branch, activation, panel, authorization |
| [Worktree 생성은 현재 패널 대화가 source다](./worktree-creation-parent-gate.md) | active | high | 2026-08-31 | 090cb14 | worktree, fork-panel, current-panel, hotfix, context, profile-driven |
| [Worktree 의존성 준비는 조건부 worker가 맡는다](./worktree-dependency-bootstrap-worker.md) | active | high | 2026-08-31 | 090cb14 | worktree, dependencies, bootstrap, profile-driven, worker, subagent |
| [Worktree는 실행 경계다](./worktree-execution-boundary.md) | active | high | 2026-08-31 | 090cb14 | worktree, workspace, repo, branch, execution-boundary, cwd-binding |
| [Worktree 세션 연속성과 식별성 원칙](./worktree-session-continuity.md) | active | high | 2026-08-31 | 090cb14 | worktree, session, revive, fork-panel, panel-inbox, handoff |
