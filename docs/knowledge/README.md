...
| [Verify Report와 coverage-aware 증거 검증 흐름](./verify-report-workflow.md) | active | high | 2026-05-30 | e51d6d1 | verify-report, verification, evidence, coverage, capture, crop |
