...
|---|---|---:|---:|---:|---|
| [Self-healing은 actionable item만 수정한다](./self-healing-actionable-loop.md) | active | high | 2026-05-08 | fdf91a4 | self-healing, actionable, worker, fix-class, subagent, 자동수정 |
| [Stress Interview는 다축 검토다](./stress-interview-multi-axis-review.md) | active | high | 2026-05-08 | fdf91a4 | stress-interview, review, verifier, reviewer, challenger, subagent |
| [Codex-first subagent 모델 운용 정책](./subagent-model-policy.md) | active | high | 2026-05-08 | fdf91a4 | subagent, codex, model-policy, worker, finder, searcher |
| [Subagent 위임은 구체 프롬프트를 요구한다](./subagent-prompt-specificity.md) | active | high | 2026-05-08 | fdf91a4 | subagent, prompt, delegation, worker, context, 위임 |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [수정 전에 근본 원인을 좁힌다](./root-cause-before-fix.md) | active | high | 2026-05-08 | fdf91a4 | debugging, root-cause, triage, error-recovery, systematic, 디버깅 |

### knowledge

| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [낮은 confidence 판단은 정합성 PR로 올린다](./confidence-sensitive-review.md) | active | high | 2026-05-08 | fdf91a4 | confidence, review, freshness, ai-actions, user-review, 정합성 |
| [Deterministic action과 AI review action은 분리한다](./deterministic-vs-ai-actions.md) | active | high | 2026-05-08 | fdf91a4 | knowledge, deterministic, ai-actions, review, automation, 정합성 |
...
| [pilee 지식 계층과 정합성 갱신](./pilee-knowledge-system.md) | active | high | 2026-05-08 | fdf91a4 | pilee, knowledge, history, journal, sanitized, reviewed-at |
| [Private journal과 public doctrine은 분리한다](./private-journal-public-doctrine.md) | active | high | 2026-05-08 | fdf91a4 | knowledge, journal, privacy, sanitized, doctrine, history |
...
| [Retro는 private reflection이다](./retro-private-reflection-boundary.md) | active | high | 2026-05-08 | fdf91a4 | retro, notion, reflection, private, journal, 회고 |
...
| [Frame과 Verify는 구조화 계약이다](./frame-verify-contract.md) | active | high | 2026-05-08 | fdf91a4 | frame, verify, frame-json, success-criteria, contract, verification |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [검토 산출물은 다시 열 수 있어야 한다](./artifact-archive-reopenability.md) | active | high | 2026-05-08 | fdf91a4 | artifact, archive, show-report, history, html, reopen |
| [AskUserQuestion은 의사결정 게이트다](./ask-user-question-decision-gates.md) | active | high | 2026-05-08 | fdf91a4 | ask-user-question, tft, decision-gate, question, non-delegable, 질문 |
| [AskUserQuestion 옵션은 행동 분기를 표현한다](./ask-user-question-option-design.md) | active | high | 2026-05-08 | fdf91a4 | ask-user-question, option, wording, ceremony, tft, 질문 |
...
| [Live artifact는 local preview first다](./live-artifact-preview-pattern.md) | active | high | 2026-05-08 | fdf91a4 | artifact, glimpse, preview, sse, upload, local-first |
...
| [Private overlay package는 회사·개인 실행 맥락을 담는다](./private-overlay-package-boundary.md) | active | high | 2026-05-08 | fdf91a4 | privacy, package, overlay, skill, company-context |
...
| [Command shim은 skill source of truth를 지킨다](./tft-command-shim-skill-routing.md) | active | high | 2026-05-08 | fdf91a4 | command-shim, skill, tft, frame, slash-command, routing |
...
| [Worktree 의존성 준비는 조건부 worker가 맡는다](./worktree-dependency-bootstrap-worker.md) | active | high | 2026-05-08 | fdf91a4 | worktree, dependencies, bootstrap, profile-driven, worker, subagent |
| [Worktree는 실행 경계다](./worktree-execution-boundary.md) | active | high | 2026-05-08 | fdf91a4 | worktree, workspace, repo, branch, execution-boundary, 워크트리 |
