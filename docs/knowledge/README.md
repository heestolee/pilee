...
| [테스트는 책임 경계에 맞춰 다듬는다](./test-boundary-refactor.md) | active | high | 2026-06-16 | 8e02ae5 | testing, mock, refactor, boundary, unit-test, contract-test |
...
| [반복 워크플로 실패는 guard/flow로 고정한다](./workflow-guard-enforced-flow.md) | active | high | 2026-06-03 | 61ccbc9 | workflow, guard, intent, audit, hotfix, continuation |
