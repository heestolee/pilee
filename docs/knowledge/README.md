...
| [Auto-commit은 명시 계획만 실행한다](./auto-commit-explicit-plan-gate.md) | active | high | 2026-06-04 | ce5e875 | auto-commit, git, commit, plan, safety |
...
| [Slice 완료는 commit 후보를 만든다](./slice-auto-commit-rhythm.md) | active | high | 2026-06-04 | e123af1 | frame, slice, auto-commit, work-context, git |
