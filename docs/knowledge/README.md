...
| [학습노트 companion은 독립 canonical을 sidecar로 연결한다](./learning-note-companion-artifact.md) | active | high | 2026-08-30 | 5d2d11a | learning-note, companion-artifact, frame-v2, study-hard, worktree, checkpoint |
...
| [작업공간 동작과 panel activation은 별도 계약이다](./workspace-action-panel-activation-contract.md) | active | high | 2026-08-26 | 272c85b | workspace, worktree, branch, activation, panel, authorization |
...
| [Worktree 세션 연속성과 식별성 원칙](./worktree-session-continuity.md) | active | high | 2026-08-26 | 272c85b | worktree, session, revive, fork-panel, panel-inbox, handoff |
