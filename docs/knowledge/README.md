...
| [MCP 결과는 구조화 출력부터 digest-first로 다룬다](./mcp-digest-first-artifacts.md) | active | high | 2026-06-02 | 66927aa | mcp, digest-first, tool-output, lazy-retrieval |
...
| [도구 출력은 대화 흐름을 침범하지 않는다](./tool-output-noise-management.md) | active | high | 2026-06-02 | 66927aa | tool-output, collapse, noise, ui, usage, renderer |
