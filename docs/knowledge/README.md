...
| [Self-healing은 actionable item만 수정한다](./self-healing-actionable-loop.md) | active | high | 2026-05-09 | 7db0307 | self-healing, actionable, worker, fix-class, subagent, 자동수정 |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [Architecture friction은 TFT의 검증 축이다](./architecture-friction-tft-lens.md) | active | high | 2026-05-09 | 8f4b01c | architecture, frame, decide, verify, deep-module, shallow-module |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [수정 전에 근본 원인을 좁힌다](./root-cause-before-fix.md) | active | high | 2026-05-09 | 7db0307 | debugging, root-cause, triage, error-recovery, systematic, 디버깅 |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [Deterministic fallback은 workflow를 보존한다](./deterministic-fallbacks-preserve-workflow.md) | active | high | 2026-05-09 | 8f4b01c | fallback, deterministic, model-failure, resilience, web-search, report |
| [Embedded WebView script는 escape 경계를 보존한다](./embedded-webview-script-escape-boundary.md) | active | high | 2026-05-09 | 8f4b01c | webview, embedded-script, escape, string-raw, regex, glimpse |
| [MCP stderr는 TUI 출력이 아니다](./mcp-stderr-isolation.md) | active | high | 2026-05-08 | 667cefb | mcp, stderr, stdio, terminal, tui, noise |
| [터미널 연동은 host adapter로 다룬다](./terminal-host-integration.md) | active | high | 2026-05-09 | 8f4b01c | terminal, ghostty, applescript, notify, host, integration |
...
| [User-facing 출력은 한국어를 기본으로 한다](./korean-first-user-facing-output.md) | active | high | 2026-05-09 | 8f4b01c | korean-output, localization, web-search, ui, rewrite, 한국어 |
...
| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [완료 선언은 증거 뒤에만 온다](./evidence-first-verification-gate.md) | active | high | 2026-05-09 | 8f4b01c | verify, evidence, gate, done, ready, verification |
| [Frame과 Verify는 구조화 계약이다](./frame-verify-contract.md) | active | high | 2026-05-09 | 8f4b01c | frame, verify, frame-json, success-criteria, contract, verification |
| [검증 중 코드 변경은 이전 검증을 무효화한다](./verification-invalidation-on-change.md) | active | high | 2026-05-09 | 8f4b01c | verify, invalidation, code-change, freshness, gate, 검증 |
| [Verify Report와 coverage-aware 증거 검증 흐름](./verify-report-workflow.md) | active | high | 2026-05-09 | 8f4b01c | verify-report, verification, evidence, coverage, capture, crop |
...
| [Web Search curator와 승인형 요약 흐름](./web-search-curator.md) | active | high | 2026-05-09 | 8f4b01c | web-search, tavily, curator, glimpse, summary-review, korean-output |

### workflow

| Topic | Status | Confidence | Reviewed | Commit | Tags |
|---|---|---:|---:|---:|---|
| [검토 산출물은 다시 열 수 있어야 한다](./artifact-archive-reopenability.md) | active | high | 2026-05-09 | 8f4b01c | artifact, archive, show-report, archive-command, history, html |
| [AskUserQuestion은 의사결정 게이트다](./ask-user-question-decision-gates.md) | active | high | 2026-05-09 | 8f4b01c | ask-user-question, tft, decision-gate, question, non-delegable, 질문 |
| [AskUserQuestion 옵션은 행동 분기를 표현한다](./ask-user-question-option-design.md) | active | high | 2026-05-09 | 8f4b01c | ask-user-question, option, wording, ceremony, tft, 질문 |
| [Backlog는 원 세션 출처를 보존한다](./backlog-source-session-provenance.md) | active | high | 2026-05-09 | 8f4b01c | backlog, tasks, provenance, source-session, session, 맥락 |
...
| [Decide는 선택을 한 번 공격한다](./decide-tradeoff-challenge.md) | active | high | 2026-05-09 | 8f4b01c | decide, tradeoff, challenge, productive-resistance, frame-json, decision |
...
| [Frame identity는 cwd보다 작업 의도를 우선한다](./frame-planning-identity.md) | active | high | 2026-05-09 | 7db0307 | frame, planning, identity, home-directory, ticket, session-title |
| [TFT Studio는 TFT 단계를 작업 단위 UI로 묶는다](./frame-studio-interactive-decision-ui.md) | active | high | 2026-05-09 | 7db0307 | tft-studio, frame-studio, frame, glimpse, ask-user-question, decision-ui |
| [Live artifact는 local preview first다](./live-artifact-preview-pattern.md) | active | high | 2026-05-09 | 8f4b01c | artifact, glimpse, preview, sse, upload, local-first |
...
| [Private overlay package는 회사·개인 실행 맥락을 담는다](./private-overlay-package-boundary.md) | active | high | 2026-05-09 | 8f4b01c | privacy, package, overlay, skill, company-context |
...
| [변경된 줄은 요청으로 추적 가능해야 한다](./request-traceability-surgical-changes.md) | active | high | 2026-05-09 | 8f4b01c | request-traceability, surgical-change, karpathy, diff, scope, review |
...
| [세션 분류는 원본 위의 sidecar다](./session-classification-sidecar.md) | active | high | 2026-05-09 | 8f4b01c | archive, show-report, session-classification, sidecar, session, ai-suggestion |
| [Session export는 원본을 보존하는 adapter를 거친다](./session-export-source-preservation.md) | active | high | 2026-05-09 | 8f4b01c | session-export, source-preservation, jsonl, conductor, normalize, show-report |
...
| [Command shim은 skill source of truth를 지킨다](./tft-command-shim-skill-routing.md) | active | high | 2026-05-09 | 8f4b01c | command-shim, skill, tft, frame, slash-command, routing |
...
| [Worktree는 실행 경계다](./worktree-execution-boundary.md) | active | high | 2026-05-09 | 8f4b01c | worktree, workspace, repo, branch, execution-boundary, 워크트리 |
