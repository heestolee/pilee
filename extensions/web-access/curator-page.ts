...
export function generateCuratorPage(
	...
	sessionToken: string,
	timeout: number,
	availableProviders: { tavily: boolean },
...
const SCRIPT = `(function() {
  ...
  var providers = ["tavily"];
  var availProviders = DATA.availableProviders && typeof DATA.availableProviders === "object" ? DATA.availableProviders : {};
  var workflow = "summary-review";
  var initialDefaultProvider = typeof DATA.defaultProvider === "string" ? DATA.defaultProvider : "tavily";
  if (providers.indexOf(initialDefaultProvider) === -1) initialDefaultProvider = "tavily";
