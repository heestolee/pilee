// Inspired by github.com/jonghakseo/my-pi's bash-tool-override; adapted to pilee's minimal-output policy.
import {
...
class BashCallPreview implements Component {
	...
	constructor(header: string, command: string, theme: Theme) {
		this.header = header;
