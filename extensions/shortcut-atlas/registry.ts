...
export const TERMINAL_SHORTCUTS: ShortcutEntry[] = [
	one("cmd+t", "새 터미널 탭", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+n", "새 터미널 윈도우", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+w", "현재 surface 닫기", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+alt+w", "현재 탭 닫기", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+w", "현재 윈도우 닫기", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+alt+shift+w", "모든 윈도우 닫기", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+d", "오른쪽 분할", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+d", "아래쪽 분할", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+[", "이전 split", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+]", "다음 split", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+alt+up", "위 split으로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+alt+down", "아래 split으로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+alt+left", "왼쪽 split으로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+alt+right", "오른쪽 split으로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+ctrl+up", "split 위로 리사이즈", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+ctrl+down", "split 아래로 리사이즈", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+ctrl+left", "split 왼쪽으로 리사이즈", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+ctrl+right", "split 오른쪽으로 리사이즈", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+ctrl+=", "split 크기 균등화", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("ctrl+tab", "다음 탭", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("ctrl+shift+tab", "이전 탭", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+]", "다음 탭", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+[", "이전 탭", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	...many(["cmd+1", "cmd+2", "cmd+3", "cmd+4", "cmd+5", "cmd+6", "cmd+7", "cmd+8"], "해당 번호 탭으로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+9", "마지막 탭으로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+enter", "전체화면 토글", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+ctrl+f", "전체화면 토글", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+enter", "split zoom 토글", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+p", "Ghostty command palette", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+,", "Ghostty config 열기", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+,", "Ghostty config reload", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+q", "Ghostty 종료", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+k", "터미널 화면 지우기", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+a", "전체 선택", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+c", "복사", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+v", "붙여넣기", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+v", "selection 붙여넣기", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+=", "폰트/페이지 확대", "terminal", "Ghostty/Glimpse host", "ghostty +list-keybinds + Glimpse host patch"),
	one("cmd+-", "폰트/페이지 축소", "terminal", "Ghostty/Glimpse host", "ghostty +list-keybinds + Glimpse host patch"),
	one("cmd+0", "폰트/페이지 확대 초기화", "terminal", "Ghostty/Glimpse host", "ghostty +list-keybinds + Glimpse host patch"),
	one("cmd+home", "맨 위로 스크롤", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+end", "맨 아래로 스크롤", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+pageup", "페이지 위로 스크롤", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+pagedown", "페이지 아래로 스크롤", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+up", "이전 prompt로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+down", "다음 prompt로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+up", "이전 prompt로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+down", "다음 prompt로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+f", "검색 시작", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+e", "선택 검색", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+g", "다음 검색 결과", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+g", "이전 검색 결과", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+shift+f", "검색 종료", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+alt+i", "inspector 토글", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+left", "라인 시작으로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+right", "라인 끝으로 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("cmd+backspace", "라인 시작까지 삭제", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("alt+left", "단어 왼쪽 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
	one("alt+right", "단어 오른쪽 이동", "terminal", "Ghostty/macOS", "ghostty +list-keybinds"),
];
