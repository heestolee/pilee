...
| extension | `extensions/frame-v2` | [Frame V2 Learning Note Pilot](./docs/knowledge/frame-v2-learning-note-pilot.md) |
...
| extension | `extensions/study-hard` | [Frame V2 Learning Note Pilot](./docs/knowledge/frame-v2-learning-note-pilot.md)<br>[Study Hard Public Engine Private Publisher](./docs/knowledge/study-hard-public-engine-private-publisher.md) |
...
| skill | `skills/frame-v2` | [Frame V2 Learning Note Pilot](./docs/knowledge/frame-v2-learning-note-pilot.md) |
...
| skill | `skills/pr-ship` | [Parallel Workflow Analysis Single Writer](./docs/knowledge/parallel-workflow-analysis-single-writer.md)<br>[Ship PR Ship Review Boundary](./docs/knowledge/ship-pr-ship-review-boundary.md)<br>[Subagent Skill Delegation](./docs/knowledge/subagent-skill-delegation.md) |
...
59 extensions. Extensions that do not register tools, such as spinner or session-title, add no tool-schema token cost.
