...
| extension | `extensions/preflight` | [Private Overlay Package Boundary](./docs/knowledge/private-overlay-package-boundary.md)<br>[Root Cause Before Fix](./docs/knowledge/root-cause-before-fix.md)<br>[Repeated validation failures are separated by a baseline cache](./docs/knowledge/validation-baseline-failure-cache.md) |
...
| extension | `extensions/tui-ask` | [TUI Ask is a lightweight decision gate](./docs/knowledge/tui-ask-decision-overlay.md) |
...
| skill | `skills/ask-user-question-rules` | [Ask User Question Decision Gates](./docs/knowledge/ask-user-question-decision-gates.md)<br>[Ask User Question Option Design](./docs/knowledge/ask-user-question-option-design.md)<br>[Theme Information Hierarchy](./docs/knowledge/theme-information-hierarchy.md)<br>[TUI Ask is a lightweight decision gate](./docs/knowledge/tui-ask-decision-overlay.md) |
| skill | `skills/ci-ship` | [Ci Ship Failure Response Boundary](./docs/knowledge/ci-ship-failure-response-boundary.md)<br>[Subagent Skill Delegation](./docs/knowledge/subagent-skill-delegation.md) |
...
| skill | `skills/incremental-implementation` | [Change Integration Discipline](./docs/knowledge/change-integration-discipline.md)<br>[Request Traceability Surgical Changes](./docs/knowledge/request-traceability-surgical-changes.md)<br>[Workflow weight must match change risk](./docs/knowledge/workflow-weight-proportionality.md) |
...
| skill | `skills/pilee-final-check` | [Ember Ship Release Train](./docs/knowledge/ember-ship-release-train.md)<br>[Pilee Final Check Gate](./docs/knowledge/pilee-final-check-gate.md) |
...
| skill | `skills/ship` | [Ship PR Ship Review Boundary](./docs/knowledge/ship-pr-ship-review-boundary.md)<br>[Subagent Skill Delegation](./docs/knowledge/subagent-skill-delegation.md) |
...
44 extensions. Extensions that do not register tools, such as spinner or session-title, add no tool-schema token cost.
...
| **ember-ship** | Pilee knowledge stale resolution, generated/history sync, and merge release train |
