...
| extension | `extensions/ember-ship` | [Ember Ship Release Train](./docs/knowledge/ember-ship-release-train.md)<br>[Knowledge Review Queue PR Body](./docs/knowledge/knowledge-review-queue-pr-body.md) |
