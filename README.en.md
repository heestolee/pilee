...
| extension | `extensions/workflow-guard` | [Repeated workflow failures become enforced guard flows](./docs/knowledge/workflow-guard-enforced-flow.md) |
...
45 extensions. Extensions that do not register tools, such as spinner or session-title, add no tool-schema token cost.
