...
| extension | `extensions/auto-commit` | [Auto-commit executes only explicit plans](./docs/knowledge/auto-commit-explicit-plan-gate.md)<br>[Repo Status Index Lock Coordination](./docs/knowledge/repo-status-index-lock-coordination.md)<br>[Slice Auto Commit Rhythm](./docs/knowledge/slice-auto-commit-rhythm.md) |
...
| extension | `extensions/convention-lens` | [Convention Lens Event Driven Projection](./docs/knowledge/convention-lens-event-driven-projection.md) |
...
| extension | `extensions/frame-v2` | [Frame V2 Learning Note Pilot](./docs/knowledge/frame-v2-learning-note-pilot.md)<br>[Learning Note Companion Artifact](./docs/knowledge/learning-note-companion-artifact.md) |
...
| extension | `extensions/pr-review` | [Convention Lens Event Driven Projection](./docs/knowledge/convention-lens-event-driven-projection.md)<br>[Human PR Review Precedent Harness](./docs/knowledge/human-pr-review-precedent-harness.md)<br>[Learning Note Companion Artifact](./docs/knowledge/learning-note-companion-artifact.md)<br>[Question UI Execution Owner Routing](./docs/knowledge/question-ui-execution-owner-routing.md)<br>[Study Hard Public Engine Private Publisher](./docs/knowledge/study-hard-public-engine-private-publisher.md)<br>[Workspace Action Panel Activation Contract](./docs/knowledge/workspace-action-panel-activation-contract.md) |
...
| extension | `extensions/questions` | [Question UI Execution Owner Routing](./docs/knowledge/question-ui-execution-owner-routing.md) |
| extension | `extensions/queued-messages` | [Parallel Workflow Analysis Single Writer](./docs/knowledge/parallel-workflow-analysis-single-writer.md)<br>[Queued Command Prefill Boundary](./docs/knowledge/queued-command-prefill-boundary.md) |
...
| extension | `extensions/ship-commands` | [Ci Ship Failure Response Boundary](./docs/knowledge/ci-ship-failure-response-boundary.md)<br>[Parallel Workflow Analysis Single Writer](./docs/knowledge/parallel-workflow-analysis-single-writer.md)<br>[Ship PR Ship Review Boundary](./docs/knowledge/ship-pr-ship-review-boundary.md)<br>[Subagent Skill Delegation](./docs/knowledge/subagent-skill-delegation.md) |
...
| extension | `extensions/study-hard` | [Frame V2 Learning Note Pilot](./docs/knowledge/frame-v2-learning-note-pilot.md)<br>[Human PR Review Precedent Harness](./docs/knowledge/human-pr-review-precedent-harness.md)<br>[Learning Note Companion Artifact](./docs/knowledge/learning-note-companion-artifact.md)<br>[Question UI Execution Owner Routing](./docs/knowledge/question-ui-execution-owner-routing.md)<br>[Study Hard Public Engine Private Publisher](./docs/knowledge/study-hard-public-engine-private-publisher.md)<br>[Study Hard Worker Flexible Generation Strict Apply](./docs/knowledge/study-hard-worker-flexible-generation-strict-apply.md)<br>[TFT Visual Structure Renderer](./docs/knowledge/tft-visual-structure-renderer.md) |
| extension | `extensions/subagent` | [AI Worker Readiness Orchestrator](./docs/knowledge/ai-worker-readiness-orchestrator.md)<br>[Convention Lens Event Driven Projection](./docs/knowledge/convention-lens-event-driven-projection.md)<br>[Final Verification Parallelization](./docs/knowledge/final-verification-parallelization.md)<br>[Parallel Workflow Analysis Single Writer](./docs/knowledge/parallel-workflow-analysis-single-writer.md)<br>[Question UI Execution Owner Routing](./docs/knowledge/question-ui-execution-owner-routing.md)<br>[Queued Command Prefill Boundary](./docs/knowledge/queued-command-prefill-boundary.md)<br>[Self Healing Actionable Loop](./docs/knowledge/self-healing-actionable-loop.md)<br>[Stress Interview Multi Axis Review](./docs/knowledge/stress-interview-multi-axis-review.md)<br>[Study Hard Worker Flexible Generation Strict Apply](./docs/knowledge/study-hard-worker-flexible-generation-strict-apply.md)<br>[Subagent Model Policy](./docs/knowledge/subagent-model-policy.md)<br>[Subagent Prompt Specificity](./docs/knowledge/subagent-prompt-specificity.md)<br>[Subagent Skill Delegation](./docs/knowledge/subagent-skill-delegation.md)<br>[Ultra Proactive Delegation Mode](./docs/knowledge/ultra-proactive-delegation-mode.md) |
...
| extension | `extensions/utils` | [Convention Lens Event Driven Projection](./docs/knowledge/convention-lens-event-driven-projection.md)<br>[Frame Studio Interactive Decision UI](./docs/knowledge/frame-studio-interactive-decision-ui.md)<br>[MCP Stderr Isolation](./docs/knowledge/mcp-stderr-isolation.md)<br>[Read Edit Tool Output Override](./docs/knowledge/read-edit-tool-output-override.md)<br>[Repo Status Index Lock Coordination](./docs/knowledge/repo-status-index-lock-coordination.md)<br>[Session Export Source Preservation](./docs/knowledge/session-export-source-preservation.md)<br>[Study Hard Public Engine Private Publisher](./docs/knowledge/study-hard-public-engine-private-publisher.md)<br>[Terminal Host Integration](./docs/knowledge/terminal-host-integration.md)<br>[Utility Surface Stays Invisible](./docs/knowledge/utility-surface-stays-invisible.md)<br>[Working Context Card compresses large context into the current slice](./docs/knowledge/work-context-card-task-board.md) |
...
| extension | `extensions/workflow-guard` | [External Issue Preview Gate](./docs/knowledge/external-issue-preview-gate.md)<br>[Long-running sessions are controlled by phases and stop-lines](./docs/knowledge/long-running-session-control.md)<br>[Slice Auto Commit Rhythm](./docs/knowledge/slice-auto-commit-rhythm.md)<br>[Ultra Proactive Delegation Mode](./docs/knowledge/ultra-proactive-delegation-mode.md)<br>[Working Context Card compresses large context into the current slice](./docs/knowledge/work-context-card-task-board.md)<br>[Repeated workflow failures become enforced guard flows](./docs/knowledge/workflow-guard-enforced-flow.md)<br>[Workspace Action Panel Activation Contract](./docs/knowledge/workspace-action-panel-activation-contract.md) |
...
| skill | `skills/ci-ship` | [Ci Ship Failure Response Boundary](./docs/knowledge/ci-ship-failure-response-boundary.md)<br>[Parallel Workflow Analysis Single Writer](./docs/knowledge/parallel-workflow-analysis-single-writer.md)<br>[Runtime Fanout Diagnosis](./docs/knowledge/runtime-fanout-diagnosis.md)<br>[Subagent Skill Delegation](./docs/knowledge/subagent-skill-delegation.md) |
...
| skill | `skills/meta-review` | [Human PR Review Precedent Harness](./docs/knowledge/human-pr-review-precedent-harness.md) |
...
| skill | `skills/pr-ship` | [Learning Note Companion Artifact](./docs/knowledge/learning-note-companion-artifact.md)<br>[Parallel Workflow Analysis Single Writer](./docs/knowledge/parallel-workflow-analysis-single-writer.md)<br>[Ship PR Ship Review Boundary](./docs/knowledge/ship-pr-ship-review-boundary.md)<br>[Subagent Skill Delegation](./docs/knowledge/subagent-skill-delegation.md) |
| skill | `skills/runtime-fanout-triage` | [Runtime Fanout Diagnosis](./docs/knowledge/runtime-fanout-diagnosis.md) |
| skill | `skills/self-healing` | [AI Worker Readiness Orchestrator](./docs/knowledge/ai-worker-readiness-orchestrator.md)<br>[Parallel Workflow Analysis Single Writer](./docs/knowledge/parallel-workflow-analysis-single-writer.md)<br>[Self Healing Actionable Loop](./docs/knowledge/self-healing-actionable-loop.md)<br>[Subagent Model Policy](./docs/knowledge/subagent-model-policy.md)<br>[Subagent Prompt Specificity](./docs/knowledge/subagent-prompt-specificity.md)<br>[Test Boundary Refactor](./docs/knowledge/test-boundary-refactor.md) |
| skill | `skills/ship` | [External Issue Preview Gate](./docs/knowledge/external-issue-preview-gate.md)<br>[Final Verification Parallelization](./docs/knowledge/final-verification-parallelization.md)<br>[Learning Note Companion Artifact](./docs/knowledge/learning-note-companion-artifact.md)<br>[Ship PR Ship Review Boundary](./docs/knowledge/ship-pr-ship-review-boundary.md)<br>[Subagent Skill Delegation](./docs/knowledge/subagent-skill-delegation.md) |
...
| skill | `skills/test-boundary-refactor` | [Convention Lens Event Driven Projection](./docs/knowledge/convention-lens-event-driven-projection.md)<br>[Test Boundary Refactor](./docs/knowledge/test-boundary-refactor.md) |
...
63 extensions. Extensions that do not register tools, such as spinner or session-title, add no tool-schema token cost.
...
| **frame-v2** | `/frame-v2` pilot connecting an initial learning note, Frame visuals, Study Hard refinement, and implementation start |
| **study-hard** | `/study-hard` learning board with concept maps, flows, Q&A, revisions, and HTML/Notion export |
...
| **convention-lens** | Projects diff-relevant conventions at `agent_settled` for shadow, review, and safe repair modes |
...
| **questions** | TODO: inventory role needed |
...
| **frame-v2** | Builds a draft-first or guided learning note, refines it in Study Hard, then promotes it to a standard frame and implementation |
...
| **meta-review** | Explains current-work or external-PR diffs and manages review judgments and revisions in the Study Hard Code Review tab |
