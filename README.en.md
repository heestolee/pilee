...
| extension | `extensions/pr-review` | [Convention Lens Event Driven Projection](./docs/knowledge/convention-lens-event-driven-projection.md)<br>[Human PR Review Precedent Harness](./docs/knowledge/human-pr-review-precedent-harness.md) |
