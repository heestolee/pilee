...
| extension | `extensions/work-context` | [Task Work Map Overlay](./docs/knowledge/task-work-map-overlay.md)<br>[Working Context Card compresses large context into the current slice](./docs/knowledge/work-context-card-task-board.md) |
